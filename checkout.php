	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : 0877-7662-3080</li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">UBelanja</a></h1>
			</div>
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> barang di UBelanja</span></h1>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Jln.Raya-Serang, Pakupatan, Serang-Banten</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">bumt@gmail</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>0877-7662-3080</li>
					</ul>
				</div>
				<div class="clearfix"> </div>
			</div>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2022 Badan Usaha Mahasiswa Tritayasa All rights reserved</p>
			</div>
		</div>
